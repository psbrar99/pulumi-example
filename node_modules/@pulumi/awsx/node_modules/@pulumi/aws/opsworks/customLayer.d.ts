...
export declare class CustomLayer extends pulumi.CustomResource {
     ...
     */
    readonly ebsVolumes: pulumi.Output<outputs.opsworks.CustomLayerEbsVolume[] | undefined>;
    /**
...
export interface CustomLayerState {
     ...
     * `ebsVolume` blocks, as described below, will each create an EBS volume and connect it to the layer's instances.
     */
    readonly ebsVolumes?: pulumi.Input<pulumi.Input<inputs.opsworks.CustomLayerEbsVolume>[]>;
    /**
     * Name of an Elastic Load Balancer to attach to this layer
     */
