...
export declare class PhpAppLayer extends pulumi.CustomResource {
     ...
     */
    readonly ebsVolumes: pulumi.Output<outputs.opsworks.PhpAppLayerEbsVolume[] | undefined>;
    /**
...
export interface PhpAppLayerState {
     ...
     * `ebsVolume` blocks, as described below, will each create an EBS volume and connect it to the layer's instances.
     */
    readonly ebsVolumes?: pulumi.Input<pulumi.Input<inputs.opsworks.PhpAppLayerEbsVolume>[]>;
    /**
     * Name of an Elastic Load Balancer to attach to this layer
     */
