 ...
 */
export declare class MemberAccountAssociation extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MemberAccountAssociationState, opts?: pulumi.CustomResourceOptions): MemberAccountAssociation;
    /**
     * Returns true if the given object is an instance of MemberAccountAssociation.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is MemberAccountAssociation;
    /**
     * The ID of the AWS account that you want to associate with Amazon Macie as a member account.
     */
    readonly memberAccountId: pulumi.Output<string>;
    /**
