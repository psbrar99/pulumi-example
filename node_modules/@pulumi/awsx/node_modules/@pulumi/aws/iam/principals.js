 ...
 * Service Principal for Amazon Certificate Manager
 */
exports.AcmServicePrincipal = { Service: "acm.amazonaws.com" };
/**
 * @deprecated
 * Service Principal for API Gateway
 */
exports.ApiGatewayPrincipal = { Service: "apigateway.amazonaws.com" };
/**
 * @deprecated
 * Service Principal for Athena
 */
exports.AthenaPrincipal = { Service: "athena.amazonaws.com" };
/**
 * @deprecated
 * Service Principal for Autoscaling
 */
exports.AutoscalingPrincipal = { Service: "autoscaling.amazonaws.com" };
/**
 * @deprecated
 * Service Principal for Cloud Directory
 */
exports.CloudDirectoryPrincipal = { Service: "clouddirectory.amazonaws.com" };
/**
 * @deprecated
 * Service Principal for Cloudformation
 */
exports.CloudformationPrincipal = { Service: "cloudformation.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for Cloudfront
 */
exports.CloudfrontPrincipal = { Service: "cloudfront.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for Cloud Search
 */
exports.CloudSearchPrincipal = { Service: "cloudsearch.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for Cloudtrail
 */
exports.CloudtrailPrincipal = { Service: "cloudtrail.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for CodeCommit
 */
exports.CodeCommitPrincipal = { Service: "codecommit.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for CodeDeploy
 */
exports.CodeDeployPrincipal = { Service: "codedeploy.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for CodePipeline
 */
exports.CodePipelinePrincipal = { Service: "codepipeline.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for EC2 Config Service
 */
exports.ConfigPrincipal = { Service: "config.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for Data Pipeline
 */
exports.DataPipelinePrincipal = { Service: "datapipeline.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for DirectConnect
 */
exports.DirectConnectPrincipal = { Service: "directconnect.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for Directory Services
 */
exports.DirectoryServicesPrincipal = { Service: "ds.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for DynamoDB
 */
exports.DynamoDbPrincipal = { Service: "dynamodb.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for EC2
 */
exports.Ec2Principal = { Service: "ec2.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for Elastic Container Registry
 */
exports.EcrPrincipal = { Service: "ecr.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for Elastic Container Service
 */
exports.EcsPrincipal = { Service: "ecs.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for Edge Lambda
 */
exports.EdgeLambdaPrincipal = { Service: "edgelambda.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for Elasticache
 */
exports.ElasticachePrincipal = { Service: "elasticache.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for Elastic Beanstalk
 */
exports.ElasticBeanstalkPrincipal = { Service: "elasticbeanstalk.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for Elastic File System
 */
exports.ElasticFileSystemPrincipal = { Service: "elasticfilesystem.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for Elastic Load Balancing
 */
exports.ElasticLoadBalancingPrincipal = { Service: "elasticloadbalancing.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for Elastic MapReduce
 */
exports.ElasticMapReducePrincipal = { Service: "elasticmapreduce.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for Events
 */
exports.EventsPrincipal = { Service: "events.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for Health
 */
exports.HealthPrincipal = { Service: "health.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for IAM
 */
exports.IamPrincipal = { Service: "iam.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for AWS Inspector
 */
exports.InspectorPrincipal = { Service: "inspector.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for Kinesis
 */
exports.KinesisPrincipal = { Service: "kinesis.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for Key Mangaement Service
 */
exports.KmsPrincipal = { Service: "kms.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for Lambda
 */
exports.LambdaPrincipal = { Service: "lambda.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for Lightsail
 */
exports.LightsailPrincipal = { Service: "lightsail.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for Cloudwatch Logs
 */
exports.LogsPrincipal = { Service: "logs.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for Cloudwatch Monitoring
 */
exports.MonitoringPrincipal = { Service: "monitoring.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for Opsworks
 */
exports.OpsworksPrincipal = { Service: "opsworks.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for Organizations
 */
exports.OrganizationsPrincipal = { Service: "organizations.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for Relational Database Service
 */
exports.RdsPrincipal = { Service: "rds.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for Redshift
 */
exports.RedshiftPrincipal = { Service: "redshift.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for Route 53
 */
exports.Route53Principal = { Service: "route53.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for S3
 */
exports.S3Principal = { Service: "s3.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for Service Catalog
 */
exports.ServiceCatalogPrincipal = { Service: "servicecatalog.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for Simple Email Service
 */
exports.SesPrincipal = { Service: "ses.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for Signin Service
 */
exports.SigninPrincipal = { Service: "signin.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for Simple Notification Service
 */
exports.SnsPrincipal = { Service: "sns.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for Simple Queue Service
 */
exports.SqsPrincipal = { Service: "sqs.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for Systems Manager
 */
exports.SsmPrincipal = { Service: "ssm.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for Storage Gateway
 */
exports.StorageGatewayPrincipal = { Service: "storagegateway.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for Security Token Service
 */
exports.StsPrincipal = { Service: "sts.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for AWS Support
 */
exports.SupportPrincipal = { Service: "support.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for VM Import/Export
 */
exports.VmiePrincipal = { Service: "vmie.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for VPC Flow Logs
 */
exports.VpcFlowLogsPrincipal = { Service: "vpc-flow-logs.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for Web Application Firewall
 */
exports.WafPrincipal = { Service: "waf.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for WorkDocs
 */
exports.WorkDocsPrincipal = { Service: "workdocs.amazonaws.com" };
/**
 * @deprecated Use the equivalent constant in module `Principals` instead
 * Service Principal for Workspaces
 */
exports.WorkspacesPrincipal = { Service: "workspaces.amazonaws.com" };
