 ...
 */
export declare type Callback<E, R> = (event: E, context: Context, callback: (error?: any, result?: R) => void) => Promise<R> | void;
/**
 ...
 */
export declare type CallbackFactory<E, R> = () => Callback<E, R>;
/**
 ...
 */
export declare type EventHandler<E, R> = Callback<E, R> | LambdaFunction;
/**
 ...
 * disallowed.
 */
export declare type BaseCallbackFunctionArgs = utils.Overwrite<FunctionArgs, {
    /**
